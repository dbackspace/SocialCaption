 ...
 * @author wupanjie
 */
public abstract class BaseSpecialText {
    ...
    @NonNull
    public BaseSpecialText setFlippedHorizontally(boolean flippedHorizontally) {
    ...
    @NonNull
    public BaseSpecialText setFlippedVertically(boolean flippedVertically) {
    ...
    public BaseSpecialText setMatrix(@Nullable Matrix matrix) {
    ...
    public abstract BaseSpecialText setDrawable(@NonNull Drawable drawable);

    @NonNull
    public abstract Drawable getDrawable();

    @NonNull
    public abstract BaseSpecialText setAlpha(@IntRange(from = 0, to = 255) int alpha);
    ...
    public boolean contains(@NonNull float[] point) {
        ...
        SpecialTextUtils.trapToRect(trappedRect, unrotatedWrapperCorner);
