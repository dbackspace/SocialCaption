package com.xlteam.textonpicture.external.utility.specialtext;
...
public class SpecialText extends BaseSpecialText {
    ...
    public SpecialText(@NonNull Context context) {
        this(context, null);
    }

    public SpecialText(@NonNull Context context, @Nullable Drawable drawable) {
    ...
    @NonNull
    @Override
    public SpecialText setAlpha(@IntRange(from = 0, to = 255) int alpha) {
    ...
    @Override
    public SpecialText setDrawable(@NonNull Drawable drawable) {
        this.drawable = drawable;
    ...
    @NonNull
    public SpecialText setDrawable(@NonNull Drawable drawable, @Nullable Rect region) {
        this.drawable = drawable;
        realBounds.set(0, 0, getWidth(), getHeight());
        if (region == null) {
            textRect.set(0, 0, getWidth(), getHeight());
    ...
    @NonNull
    public SpecialText setTypeface(@Nullable Typeface typeface) {
        textPaint.setTypeface(typeface);
        return this;
    }

    @NonNull
    public SpecialText setTextColor(@ColorInt int color) {
        textPaint.setColor(color);
        return this;
    }

    @NonNull
    public SpecialText setTextAlign(@NonNull Layout.Alignment alignment) {
        this.alignment = alignment;
        return this;
    }

    @NonNull
    public SpecialText setMaxTextSize(@Dimension(unit = Dimension.SP) float size) {
     ...
     */
    @NonNull
    public SpecialText setMinTextSize(float minTextSizeScaledPixels) {
        minTextSizePixels = convertSpToPx(minTextSizeScaledPixels);
        return this;
    }

    @NonNull
    public SpecialText setLineSpacing(float add, float multiplier) {
    ...
    @NonNull
    public SpecialText setText(@Nullable String text) {
        this.text = text;
        return this;
    }
