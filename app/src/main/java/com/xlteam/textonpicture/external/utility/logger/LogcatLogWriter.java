...
public class LogcatLogWriter implements LogWriter {
    ...
    private static final String TEXT_ON_PICTURE_TAG = "TextOnPicture";

    @Override
    public void v(String msg) {
        android.util.Log.v(TEXT_ON_PICTURE_TAG, msg);
    }

    @Override
    public void d(String msg) {
        android.util.Log.i(TEXT_ON_PICTURE_TAG, msg);
    }
    ...
    public void w(String msg) {
        android.util.Log.w(TEXT_ON_PICTURE_TAG, msg);
    }

    @Override
    public void e(String msg) {
        android.util.Log.e(TEXT_ON_PICTURE_TAG, msg);
    }
