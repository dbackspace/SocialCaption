...
public class PictureListFragment extends Fragment implements ILoader<CommonCaption>, CaptionAdapter.Callback {
    ...
    public PictureListFragment(int categoryNumber) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvCaption = root.findViewById(R.id.rv_picture);
